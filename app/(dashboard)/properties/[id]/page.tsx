    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Taxes & fees, plus Channex listing content when this property is Channex-managed */}
          <PropertyListingTabs propertyId={property.id} isChannex={channels?.manager === "CHANNEX"} />
